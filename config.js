...
const baseConfig = {
  ...
  AUTO_DEL: process.env.AUTO_DEL || "",
  AI_DEFAULT_PROMPT: process.env.AI_DEFAULT_PROMPT || "",
  AI_ALL_GRUP: process.env.AI_ALL_GRUP || "",
  AI_ALL_DM: process.env.AI_ALL_DM || "",
  DUYURU_KARA_LISTE: process.env.DUYURU_KARA_LISTE || "",
